    ...
    faqs:
      ...
      - question: "אחרי שהרישום הסתיים, יש רשימת המתנה? "
        answer: >
          ...
          בהחלט. אפשר לשלוח מייל עם הפרטים שלכם דרך העמוד "רישום לגן" ולבקש להכנס לרשימת ההמתנה (יש לציין אם לשנת הפעילות הנוכחית או הבאה). במידה ויתפנה מקום רלוונטי עבורכם, ניצור אתכם קשר בשמחה, נזמין אתכם לסיור התרשמות בגן ונאפשר לכם להרשם. 
