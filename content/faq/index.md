    ...
    faqs:
      - question: מה אוכלים בגן?
        answer: ואי, אחלה אוכל. התזונה בגן שלנו מבוססת על המון ירקות, המון קטניות וכמה
          ...
          (שניתן גם להפריד) כשראובנה מנהלת המטבח שלנו מכינה שקשוקה. התפריט של
          הגן נבנה יחד עם תזונאית מומחית לילדים. אנחנו אוכלים בגן ארוחת בוקר
          וצהריים ולקראת סוף היום אנחנו מתפנקים בכריכים ופירות. אנחנו גם אוכלים
          חומוס ביתי הום-מייד - חשוב לחנך גם לחומוס :) אם בא לכם לראות בדיוק מה
          אוכלים, אפשר לראות את התפריט באתר שלנו
        links:
